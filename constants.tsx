  ...
  projects: [
    {
      id: "1",
      title: "HyperNode Pro",
      description: "A low-latency event streaming platform built for real-time financial transaction processing.",
      tags: ["Rust", "WASM", "gRPC"],
      link: "#",
    ...
    },
    {
      id: "2",
      title: "Stratos UI",
      description: "A design system engine that generates cross-platform components from Figma tokens.",
  ...
  experiences: [
    {
      ...
      period: "2022 - PRESENT",
      description: "Leading the core interactions team, focusing on high-performance desktop-grade web experiences."
    },
    {
      id: "e2",
      company: "Stripe",
      ...
      period: "2020 - 2022",
      description: "Architected scalable payment dashboards processing millions of requests per second."
    }
  ],
  skills: [
    { id: "s1", name: "REACT CORE", level: 98, category: 'frontend', pid: "8821" },
    { id: "s2", name: "RUST SYSTEMS", level: 85, category: 'backend', pid: "4112" },
    { id: "s3", name: "KUBERNETES", level: 90, category: 'devops', pid: "1092" },
    { id: "s4", name: "GLSL / SHADERS", level: 75, category: 'other', pid: "3310" }
  ]
};
