  ...
  return (
    <div className="max-w-[1400px] mx-auto px-4 md:px-6 lg:px-12 pt-24 md:pt-32 pb-32 grid lg:grid-cols-[1fr_400px] gap-12 md:gap-20">
      <div className="space-y-8 md:space-y-12">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8 bg-zinc-50 dark:bg-[#0c0c0e] border border-zinc-200 dark:border-zinc-800 p-6 md:p-12 rounded-lg relative overflow-hidden shadow-sm dark:shadow-none">
          {status === 'sent' && (
            <div className="absolute inset-0 bg-white/95 dark:bg-black/90 backdrop-blur-md z-10 flex flex-col items-center justify-center text-center p-6 space-y-4 animate-in fade-in duration-500">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-zinc-900 dark:text-white">TRANSMISSION SUCCESSFUL</h3>
              <p className="text-zinc-500 font-mono text-[10px] uppercase tracking-widest">Message logged. <br/> Response: 24-48 cycles.</p>
              <button 
                type="button"
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8">
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-bold text-zinc-400 dark:text-zinc-600 uppercase tracking-widest">Address / Email</label>
              <input 
                required
                type="email" 
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8">
            <div className="space-y-2">
              <label className="text-[10px] font-bold text-zinc-400 dark:text-zinc-600 uppercase tracking-widest">Subject</label>
              <input 
                required
                type="text" 
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-bold text-zinc-400 dark:text-zinc-600 uppercase tracking-widest">Priority</label>
              <select 
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-bold text-zinc-400 dark:text-zinc-600 uppercase tracking-widest">Payload</label>
            <textarea 
              required
              rows={5}
          ...
          >
            <span className="relative z-10 flex items-center justify-center gap-3">
              {status === 'transmitting' ? (
                <>Transmitting <i className="fa-solid fa-spinner animate-spin"></i></>
              ) : (
      ...
      <div className="space-y-8 md:space-y-12">
        <div className="bg-zinc-50 dark:bg-[#0c0c0e] border border-zinc-200 dark:border-zinc-800 rounded-lg p-6 md:p-8 space-y-8 shadow-sm dark:shadow-none">
           <div className="space-y-2">
              <h4 className="text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest">Locations</h4>
              <p className="text-zinc-900 dark:text-white font-bold text-sm">{data.location}</p>
           </div>
           <div className="space-y-2">
              <h4 className="text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest">Direct</h4>
              <p className="text-zinc-900 dark:text-white font-bold text-sm">{data.email}</p>
           </div>
           <div className="pt-8 border-t border-zinc-200 dark:border-zinc-900 space-y-4">
              <h4 className="text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest">Social Matrix</h4>
              <div className="flex flex-col gap-4 font-mono text-xs">
                <a href="#" className="flex items-center justify-between text-zinc-500 hover:text-zinc-900 dark:hover:text-white group transition-colors">
                  <span>LinkedIn</span>
