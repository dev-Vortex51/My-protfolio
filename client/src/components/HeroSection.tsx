...
const HeroSection: React.FC<HeroSectionProps> = ({ data }) => {
  ...
  return (
    <section className="grid lg:grid-cols-[1fr_400px] gap-8 lg:gap-12 items-center min-h-[60vh]">
      <div className="space-y-6 md:space-y-8 overflow-hidden">
        ...
        <p className="text-base md:text-lg lg:text-xl text-zinc-600 dark:text-zinc-400 max-w-2xl font-medium leading-relaxed">
          {data.tagline ||
      ...
      <div className="bg-zinc-50 dark:bg-[#0c0c0e] border border-zinc-200 dark:border-zinc-800 rounded-lg p-4 md:p-6 font-mono text-xs md:text-sm h-64 md:h-70 lg:h-80 shadow-2xl relative flex flex-col overflow-hidden">
        ...
        <form
          ...
          className="flex gap-2 text-indigo-600 dark:text-indigo-400 mt-2 border-t border-zinc-200 dark:border-zinc-800 pt-2 shrink-0"
        >
          ...
          <input
            ...
            className="bg-transparent border-none outline-none grow text-zinc-900 dark:text-white min-w-0 text-[10px] md:text-xs"
